...
class HourAttendancePage extends StatefulWidget {
  const HourAttendancePage({
    super.key,
    required this.hour,
    required this.dept,
  ...
  @override
  State<HourAttendancePage> createState() => _HourAttendancePageState();
}

class _HourAttendancePageState extends State<HourAttendancePage> {
  List<String> hours = [
    "First",
    "Second",
    "Third",
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                            ...
                            child: StudentTile(
                              ...
                              onAttendanceStatusChanged: updateAttendanceStatus,
                            ),
                          );
                        },
                      );
